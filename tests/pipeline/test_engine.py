...
class ColumnArgs(tuple):
    ...
    def __eq__(self, other):
        return self.by_ds() == other.by_ds()

    def __hash__(self):
        return hash(self.by_ds())
...
class ConstantInputTestCase(TestCase):
    ...
    def test_loader_given_multiple_columns(self):
        ...
        loader1 = RecordingConstantLoader(constants={Loader1DataSet1.col1: 1,
                                                     Loader1DataSet1.col2: 2,
                                                     Loader1DataSet2.col1: 3,
                                                     Loader1DataSet2.col2: 4},
                                          dates=self.dates,
                                          assets=self.assets)
        loader2 = RecordingConstantLoader(constants={Loader2DataSet.col1: 5,
        ...
        self.assertEqual(set(loader1.load_calls),
                         {ColumnArgs(Loader1DataSet1.col1,
                                     Loader1DataSet2.col1),
                          ColumnArgs(Loader1DataSet1.col2,
                                     Loader1DataSet2.col2)})
        self.assertEqual(set(loader2.load_calls),
                         {ColumnArgs(Loader2DataSet.col1,
                                     Loader2DataSet.col2)})
